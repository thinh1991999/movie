...
function Card({ data, type, typeNavigate }) {
  ...
  const { name, title, id, poster_path, vote_average: score } = data;
  ...
  return (
    <div className="w-full p-2 ">
      <div className="relative rounded-md group overflow-hidden group cursor-pointer bg-gray-500 card-shadow">
